document.addEventListener('DOMContentLoaded', () => {
    ...
    if (isLoggedIn && role === 'Agent') {
        ...
        if (addPolicyForm) {
            addPolicyForm.classList.remove('hidden'); // Unhide the form if hidden initially
        ...
        // Redirect to login or show an error message if the user is not logged in or is not an agent
        alert('Access denied. Please log in as an Agent to add a new policy.');
